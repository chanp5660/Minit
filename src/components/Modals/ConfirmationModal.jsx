 ...
 * 세션 완료 확인 모달
 */
export const ConfirmationModal = ({ isOpen, onClose, activeContent, onComplete, onInProgress, darkMode }) => {
    ...
    >
      ...
      >
        ...
        <p className={`mb-6 ${
          ...
          <span className="font-semibold">"{activeContent}"</span> 작업을 완료하셨나요?
        </p>
